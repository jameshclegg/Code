...
c1.slewXY( 1, p(1,1), p(1,2), ts(1) );
c1.slewXY( 1, p(2,1), p(2,2), ts(2) );
c1.positionXY( 1, p(3,1), p(3,2) );
c1.slewXY( 1, p(3,1), p(3,2), ts(3) );
c1.slewXY( 1, p(4,1), p(4,2), ts(4) );
c1.slewXY( 1, p(5,1), p(5,2), ts(5) );
c1.slewXY( 1, p(6,1), p(6,2), ts(6) );
